...
export type CardCountAggregateSelection = {
	__typename?: "CardCountAggregateSelection";
	count: Scalars["Int"]["output"];
	name: StringAggregateSelectionNullable;
};

export type CardCountCreateInput = {
	name?: InputMaybe<Scalars["String"]["input"]>;
};

export type CardCountEdge = {
	__typename?: "CardCountEdge";
	cursor: Scalars["String"]["output"];
	node: CardCount;
};

export type CardCountOptions = {
	limit?: InputMaybe<Scalars["Int"]["input"]>;
	offset?: InputMaybe<Scalars["Int"]["input"]>;
	/** Specify one or more CardCountSort objects to sort CardCounts by. The sorts will be applied in the order in which they are arranged in the array. */
	sort?: InputMaybe<Array<CardCountSort>>;
};

/** Fields to sort CardCounts by. The order in which sorts are applied is not guaranteed when specifying many fields in one CardCountSort object. */
export type CardCountSort = {
	name?: InputMaybe<SortDirection>;
};

export type CardCountUpdateInput = {
	name?: InputMaybe<Scalars["String"]["input"]>;
};

export type CardCountWhere = {
	AND?: InputMaybe<Array<CardCountWhere>>;
	NOT?: InputMaybe<CardCountWhere>;
	OR?: InputMaybe<Array<CardCountWhere>>;
	name?: InputMaybe<Scalars["String"]["input"]>;
	name_CONTAINS?: InputMaybe<Scalars["String"]["input"]>;
	name_ENDS_WITH?: InputMaybe<Scalars["String"]["input"]>;
	name_IN?: InputMaybe<Array<InputMaybe<Scalars["String"]["input"]>>>;
...
export type CardCountsConnection = {
	__typename?: "CardCountsConnection";
	edges: Array<CardCountEdge>;
	pageInfo: PageInfo;
	totalCount: Scalars["Int"]["output"];
};
...
export type CreateCardCountsMutationResponse = {
	__typename?: "CreateCardCountsMutationResponse";
...
export type Mutation = {
	...
	createCardCounts: CreateCardCountsMutationResponse;
	...
	updateCardCounts: UpdateCardCountsMutationResponse;
...
export type MutationCreateCardCountsArgs = {
	input: Array<CardCountCreateInput>;
};
...
export type MutationDeleteCardCountsArgs = {
	where?: InputMaybe<CardCountWhere>;
};
...
export type MutationUpdateCardCountsArgs = {
	update?: InputMaybe<CardCountUpdateInput>;
	where?: InputMaybe<CardCountWhere>;
};
...
export type Query = {
	...
	cardCounts: Array<CardCount>;
	cardCountsAggregate: CardCountAggregateSelection;
	cardCountsConnection: CardCountsConnection;
	cities: Array<City>;
...
export type QueryCardCountsArgs = {
	options?: InputMaybe<CardCountOptions>;
	where?: InputMaybe<CardCountWhere>;
};

export type QueryCardCountsAggregateArgs = {
	where?: InputMaybe<CardCountWhere>;
};

export type QueryCardCountsConnectionArgs = {
	after?: InputMaybe<Scalars["String"]["input"]>;
	first?: InputMaybe<Scalars["Int"]["input"]>;
	sort?: InputMaybe<Array<InputMaybe<CardCountSort>>>;
	where?: InputMaybe<CardCountWhere>;
};
...
export type UpdateCardCountsMutationResponse = {
	__typename?: "UpdateCardCountsMutationResponse";
	cardCounts: Array<CardCount>;
	info: UpdateInfo;
};
...
export type GetCardCountsQuery = {
	__typename?: "Query";
	holidays: Array<{ __typename?: "Holiday"; name: string; nodeId: string }>;
	continents: Array<{ __typename?: "Continent"; name: string; nodeId: string }>;
	countries: Array<{ __typename?: "Country"; name: string; nodeId: string }>;
	cities: Array<{ __typename?: "City"; name: string; nodeId: string; linkedHolidays: Array<{ __typename?: "Holiday"; nodeId: string }> }>;
};
...
export type GetCitiesQuery = {
	...
	cities: Array<{
		...
		nodeId: string;
		capital: boolean;
		linkedHolidays: Array<{ __typename?: "Holiday"; nodeId: string }>;
	}>;
};
...
export type GetTownsQuery = {
	__typename?: "Query";
	towns: Array<{ __typename?: "Town"; name: string; nodeId: string; linkedHolidays: Array<{ __typename?: "Holiday"; nodeId: string }> }>;
};
...
export type GetIslandsQuery = {
	__typename?: "Query";
	islands: Array<{ __typename?: "Island"; name: string; nodeId: string; linkedHolidays: Array<{ __typename?: "Holiday"; nodeId: string }> }>;
};
...
export type GetPeopleQuery = {
	...
	people: Array<{
		...
		nodeId?: string | null;
		aliases?: string | null;
		attendedHolidays: Array<{ __typename?: "Holiday"; nodeId: string }>;
	}>;
};
...
export type GetPeopleByIdQuery = {
	...
	people: Array<{
		...
		nodeId?: string | null;
		aliases?: string | null;
		attendedHolidays: Array<{ __typename?: "Holiday"; name: string; holidayTitle: string; nodeId: string; sortDateValue: string }>;
	}>;
};
...
export type GetHolidayByIdQuery = {
	__typename?: "Query";
	holidays: Array<{
		__typename?: "Holiday";
		dateYear: string;
...
export const GetCardCountsDocument = {
	kind: "Document",
	definitions: [
		{
					...
					},
					{
						...
						selectionSet: {
							...
							selections: [
								...
								{
									kind: "Field",
									name: { kind: "Name", value: "linkedHolidays" },
									selectionSet: { kind: "SelectionSet", selections: [{ kind: "Field", name: { kind: "Name", value: "nodeId" } }] },
								},
							],
						},
					},
...
} as unknown as DocumentNode<GetCardCountsQuery, GetCardCountsQueryVariables>;
export const GetContinentsDocument = {
	kind: "Document",
	definitions: [
		{
			kind: "OperationDefinition",
			operation: "query",
			name: { kind: "Name", value: "GetContinents" },
			selectionSet: {
				kind: "SelectionSet",
				selections: [
					{
...
} as unknown as DocumentNode<GetContinentsQuery, GetContinentsQueryVariables>;
export const GetContinentByIdDocument = {
	kind: "Document",
	definitions: [
		{
			kind: "OperationDefinition",
			operation: "query",
			name: { kind: "Name", value: "GetContinentById" },
			variableDefinitions: [
				{
...
} as unknown as DocumentNode<GetContinentByIdQuery, GetContinentByIdQueryVariables>;
...
export const GetCityByIdDocument = {
	kind: "Document",
	definitions: [
		{
			kind: "OperationDefinition",
			operation: "query",
			name: { kind: "Name", value: "GetCityById" },
			variableDefinitions: [
				{
					kind: "VariableDefinition",
					variable: { kind: "Variable", name: { kind: "Name", value: "nodeId" } },
...
} as unknown as DocumentNode<GetCityByIdQuery, GetCityByIdQueryVariables>;
export const GetCapitalsDocument = {
	kind: "Document",
	definitions: [
		{
			kind: "OperationDefinition",
			operation: "query",
			name: { kind: "Name", value: "GetCapitals" },
			variableDefinitions: [
				{
					kind: "VariableDefinition",
					variable: { kind: "Variable", name: { kind: "Name", value: "capitalCheck" } },
									...
									fields: [
										{
											...
											value: { kind: "Variable", name: { kind: "Name", value: "capitalCheck" } },
										},
									],
								},
							},
...
} as unknown as DocumentNode<GetCapitalsQuery, GetCapitalsQueryVariables>;
export const GetTownsDocument = {
	kind: "Document",
	definitions: [
		{
			kind: "OperationDefinition",
			operation: "query",
			name: { kind: "Name", value: "GetTowns" },
			selectionSet: {
				kind: "SelectionSet",
				selections: [
					{
						kind: "Field",
						name: { kind: "Name", value: "towns" },
						selectionSet: {
							kind: "SelectionSet",
							selections: [
								{ kind: "Field", name: { kind: "Name", value: "name" } },
...
} as unknown as DocumentNode<GetTownsQuery, GetTownsQueryVariables>;
export const GetTownByIdDocument = {
	kind: "Document",
	definitions: [
		{
			kind: "OperationDefinition",
			operation: "query",
			name: { kind: "Name", value: "GetTownById" },
			variableDefinitions: [
				{
					kind: "VariableDefinition",
					variable: { kind: "Variable", name: { kind: "Name", value: "nodeId" } },
...
} as unknown as DocumentNode<GetTownByIdQuery, GetTownByIdQueryVariables>;
export const GetIslandsDocument = {
	kind: "Document",
	definitions: [
		{
			kind: "OperationDefinition",
			operation: "query",
			name: { kind: "Name", value: "GetIslands" },
			selectionSet: {
				kind: "SelectionSet",
				selections: [
					{
						kind: "Field",
						name: { kind: "Name", value: "islands" },
						selectionSet: {
							kind: "SelectionSet",
							selections: [
								{ kind: "Field", name: { kind: "Name", value: "name" } },
...
} as unknown as DocumentNode<GetIslandsQuery, GetIslandsQueryVariables>;
				...
				selections: [
					{
						...
						selectionSet: {
							...
							selections: [
								...
								{
									kind: "Field",
									name: { kind: "Name", value: "attendedHolidays" },
									selectionSet: { kind: "SelectionSet", selections: [{ kind: "Field", name: { kind: "Name", value: "nodeId" } }] },
								},
							],
						},
	...
	definitions: [
		{
			kind: "OperationDefinition",
			operation: "query",
			name: { kind: "Name", value: "GetPeopleById" },
			variableDefinitions: [
				{
					kind: "VariableDefinition",
					variable: { kind: "Variable", name: { kind: "Name", value: "nodeId" } },
							...
							selections: [
								...
								{ kind: "Field", name: { kind: "Name", value: "aliases" } },
								{
									...
									selectionSet: {
										...
										selections: [
											{ kind: "Field", name: { kind: "Name", value: "name" } },
											{ kind: "Field", name: { kind: "Name", value: "holidayTitle" } },
											{ kind: "Field", name: { kind: "Name", value: "nodeId" } },
											{ kind: "Field", name: { kind: "Name", value: "sortDateValue" } },
										],
									},
								},
							],
...
} as unknown as DocumentNode<GetPeopleByIdQuery, GetPeopleByIdQueryVariables>;
export const GetHolidaysDocument = {
	kind: "Document",
	definitions: [
		{
			kind: "OperationDefinition",
			operation: "query",
			name: { kind: "Name", value: "GetHolidays" },
			selectionSet: {
				kind: "SelectionSet",
				selections: [
					{
						...
						selectionSet: {
							kind: "SelectionSet",
							selections: [
								{ kind: "Field", name: { kind: "Name", value: "dateYear" } },
								{ kind: "Field", name: { kind: "Name", value: "dateMonth" } },
								{ kind: "Field", name: { kind: "Name", value: "sortDateValue" } },
								{ kind: "Field", name: { kind: "Name", value: "name" } },
								{ kind: "Field", name: { kind: "Name", value: "holidayTitle" } },
								{ kind: "Field", name: { kind: "Name", value: "nodeId" } },
								...
								{ kind: "Field", name: { kind: "Name", value: "photoAlbum" } },
								{ kind: "Field", name: { kind: "Name", value: "attendees" } },
								{ kind: "Field", name: { kind: "Name", value: "textHtmlContent" } },
								{ kind: "Field", name: { kind: "Name", value: "departingAirport" } },
							],
						},
					},
				],
...
} as unknown as DocumentNode<GetHolidaysQuery, GetHolidaysQueryVariables>;
export const GetHolidayByIdDocument = {
	kind: "Document",
	definitions: [
		{
			kind: "OperationDefinition",
			operation: "query",
			name: { kind: "Name", value: "GetHolidayById" },
			variableDefinitions: [
				{
					kind: "VariableDefinition",
					variable: { kind: "Variable", name: { kind: "Name", value: "nodeId" } },
...
} as unknown as DocumentNode<GetHolidayByIdQuery, GetHolidayByIdQueryVariables>;
